...
<div>
	...
	document.addEventListener('DOMContentLoaded', function() {
		$.ajax({
    		url: '${pageContext.request.contextPath}/reservation/onemonth_reserv',
    		type: 'GET',
    		success: function(res){
    			...
    			var events = list.map(function(item) {
    				...
    				return {
						...
						color : "#FFFFFF",
						textColor : "#000000",
						url: '${pageContext.request.contextPath}/reservation/room_choice?rRoomName='+item.rroomName+
								'&rCheckIn='+item.rcheckIn+'&rPrice='+item.rprice
					}
    			});
