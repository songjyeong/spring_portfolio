								...
								<div style="word-break: break-all; margin: 0 0px 0px 0px;">
									<div class="glores-A-complete">
										<div class="glores-A-msg-box">
											<strong class="glores-A-thx">★<br>THANK YOU! :) </strong>
											
											<p class="glores-A-txt">
												<span>${member.name } 반갑습니다 고객님!</span> 
												<span>로그인이 완료 되었습니다.</span> 
												<span class="glores-A-block">
													회원님은 저희 사이트에서 제공하는 모든 서비스와
													이벤트를 편리하게 이용하실 수 있습니다.
												</span>
												 WhiteHouse는 최고의 사이트가 되기 위해 최선의 노력을 하겠습니다. 
										...
										<div class="glores-A-btn-wrap">
											<span class="glores-A-half"> 
												...
												<a href="${pageContext.request.contextPath }/member/logout" class="glores-A-btn-type1 glores-A-big glores-A-highlight">로그아웃</a>
											</span>
										</div>
									</div>
								</div>
