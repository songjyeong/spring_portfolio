							...
							<div style="background-color: transparent;">
								<div style="word-break: break-all; margin: 0 0px 0px 0px;">
									<div class="scbd co-default">
										<!-- body -->
										<form name="frmModify" action='<c:url value='/board_modify'/>'  method="POST" style='margin: 0'>
											<fieldset class="writeForm">
													...
													<dd>
														<p>
															<input type="text" name="bTitle" id="bTitle" size="40"
																class="block" value="${getboard.bTitle }" />
												...
												<dl>
													...
													<dd>
														<textarea class="summernote" id="summernote" name="bContent"><c:out value="${getboard.bContent}" /></textarea>
														<input type="hidden" id="bNum" name="bNum" value="${getboard.bNum }">
													</dd>
												</dl>
											</fieldset>
											<div class="btngroup">
												<button type="submit" class="ui-button btn-highlight" id="subWriter">수정 완료</button>
												<button type="button" onclick="history.back()" class="ui-button">취소</button>
											</div>
										</form>
										<!-- // body -->
									</div>
