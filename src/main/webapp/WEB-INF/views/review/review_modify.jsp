							...
							<div style="background-color: transparent;">
								<div style="word-break: break-all; margin: 0 0px 0px 0px;">
									<div class="scbd co-default">
										<!-- body -->
										<form name="frmModify" action='<c:url value='/review_modify'/>'  method="post" style='margin: 0'>
											<fieldset class="writeForm">
												<div class="title">이용후기 수정</div>
												<dl>
													<dt>
														<label for="review_room">방 이름</label>
													</dt>
													<dd>
														<input type="hidden" name="vRnum" value="${getreview.vRnum}" />
														${getreview.rRoomName}
													</dd>												
												</dl>
													...
													<dd>
														<p>
															<input type="text" name="vTitle" id="vTitle" size="40"
																class="block" value="${getreview.vTitle }" />
														</p>
													</dd>
												</dl>
												...
												<dl>
													...
													<dd>
														<textarea class="summernote" id="summernote" name="vContent"><c:out value="${getreview.vContent}" /></textarea>
														<input type="hidden" id="vNum" name="vNum" value="${getreview.vNum }">
													</dd>
												</dl>
											</fieldset>
