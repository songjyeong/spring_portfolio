							...
							<div style="background-color: transparent;">
								<div style="word-break: break-all; margin: 0 0px 0px 0px;">
									<div class="scbd co-default">
										<!-- body -->
										<form name="frmWrite" action='<c:url value='/qna_add'/>'  method="post" style='margin: 0'>
											<fieldset class="writeForm">
												...
												<dl>
													...
													<dd>
														<textarea class="summernote" id="summernote" name="qContent"></textarea>
													</dd>
												</dl>
...
// 	function uploadSummernoteImageFile(files, editor, welEditable) {
// 		var data = new FormData();
// 		data.append("file", file);
// 		$.ajax({
// 			data : data,
// 			type : "POST",
// 			url : "${pageContext.request.contextPath}/qna_image_upload",
// 			contentType : false,
