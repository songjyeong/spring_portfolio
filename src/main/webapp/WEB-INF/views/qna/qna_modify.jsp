							...
							<div style="background-color: transparent;">
								<div style="word-break: break-all; margin: 0 0px 0px 0px;">
									<div class="scbd co-default">
										<!-- body -->
										<form name="frmModify" action='<c:url value='/qna_modify'/>'  method="post" style='margin: 0'>
											<fieldset class="writeForm">
												...
												<dl>
													...
													<dd>
														<input type="hidden" name="qId" value="${loginMember.id}" />
														${loginMember.id} 
													</dd>
												</dl>
												...
												<dl>
													...
													<dd>
														<p>
															<input type="text" name="qTitle" id="qTitle" size="40"
																class="block" value="${getqna.qTitle }" />
														</p>
													</dd>
												</dl>
												...
												<dl>
													...
													<dd>
														<textarea class="summernote" id="summernote" name="qContent"><c:out value="${getqna.qContent}" /></textarea>
														<input type="hidden" id="qNum" name="qNum" value="${getqna.qNum }">
													</dd>
												</dl>
												...
												<ul class="options">
													<li><label> <input type="checkbox"
															name="qStatus" value="2" /> <span>다른 사용자가 볼 수 없도록
																비밀글로 등록합니다.</span>
													</label></li>
												</ul>
											</fieldset>
											...
											<div class="btngroup">
												<button type="submit" class="ui-button btn-highlight" id="subWriter">수정 완료</button>
