...
@Data
public class Pager {
	//생성자를 이용하여 초기값을 저장하는 필드
	private int pageNum;//요청 페이지의 번호
	private int totalBoard;//전체 게시글의 갯수
	private int pageSize;//하나의 페이지에 출력될 게시글의 갯수
	private int blockSize;//하나의 블럭에 출력될 게시글 번호의 갯수
	
	//초기값이 저장된 필드값들을 계산하여 얻어진 결과값을 저장하는 필드
	private int totalPage;//전체 페이지의 갯수
	private int startRow;//요청 페이지에 출력될 게시글의 시작 행번호
	private int endRow;//요청 페이지에 출력될 게시글의 종료 행번호
	private int startPage;//현재 블록에 출력될 시작 페이지 번호
	private int endPage;//현재 블록에 출력될 종료 페이지 번호
	private int prevPage;//이전 블록에 출력될 시작 페이지 번호
	private int nextPage;//다음 블록에 출력될 시작 페이지 번호
